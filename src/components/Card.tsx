    ...
    return (
      ...
      >
        ...
        <Grid container item xs={8}>
          <Grid item xs={12}>
            <h4 className="card-name no-gutters">{props.name}</h4>
          </Grid>
          <Grid item xs={12}>
            <h5 className="card-id no-gutters">ID: {props.id}</h5>
          </Grid>
          <Grid item xs={12}>
            <div className="income-label">
              Income: <span className="bold"> ${props.income}</span>
            </div>
          </Grid>
        </Grid>
      </Grid>
